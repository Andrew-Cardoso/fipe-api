...
- Data from [Fipe API](https://deividfortuna.github.io/fipe/v2/#tag/Fipe)
...
- Run Redis on port 6969
- Configure admin email and password in .env file to properly send emails

```bash
# it will migrate, push and generate schemas using sqlite
